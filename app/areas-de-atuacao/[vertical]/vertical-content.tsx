...
import { localizeVertical, type Vertical } from "@/lib/verticals-data"
...
export function VerticalContent({
  ...
  const v = localizeVertical(rawVertical, lang)
  const cases = rawCases.map((c) => localizeCaseStudy(c, lang))
  const a = t.areas
          ...
          <div className="relative mx-auto max-w-3xl px-6 text-center">
            <Reveal>
              <h2 className="text-balance text-3xl font-semibold tracking-tight sm:text-4xl">
                {a.cta.titlePrefix} {v.label} {a.cta.titleSuffix}
              </h2>
